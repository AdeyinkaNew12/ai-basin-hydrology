...
def main():
    ...
    # Locate inputs
    # -------------------------
    ai_file = find_file("DC_CONUS_STRICT.csv")
    power_file = find_file("Power_Unique_Site_CONUS_STRICT.xlsx")
    tri_file = find_file("TRI_2024_Unique_Site_CONUS_STRICT.csv")
    ...
    power = pd.read_excel(power_file, header=0)
