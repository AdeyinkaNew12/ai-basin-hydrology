...
Workflow:
1. Load raw facility files: DC_CONUS.csv, Power_Unique_Site_CONUS.xlsx, TRI_2024_Unique_Site_CONUS.csv
...
def main():
    ...
    power_file = find_file("Power_Unique_Site_CONUS.xlsx")
    tri_file = find_file("TRI_2024_Unique_Site_CONUS.csv")
