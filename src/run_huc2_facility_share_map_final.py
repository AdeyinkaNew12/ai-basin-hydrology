...
axes[0].legend(handles=legend_handles(blue_map),
               title="Share of national facilities (%)", 
               loc="upper center", bbox_to_anchor=(0.5, -0.20), ncol=3, frameon=False, fontsize=9, title_fontsize=9)
axes[1].legend(handles=legend_handles(orng_map),
               title="Share of national facilities (%)", 
               loc="upper center", bbox_to_anchor=(0.5, -0.20), ncol=3, frameon=False, fontsize=9, title_fontsize=9)
axes[2].legend(handles=legend_handles(grn_map),
               title="Share of national facilities (%)",  
               loc="upper center", bbox_to_anchor=(0.5, -0.20), ncol=3, frameon=False, fontsize=9, title_fontsize=9)
