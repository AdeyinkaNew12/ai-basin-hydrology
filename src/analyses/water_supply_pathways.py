...
ROOT = Path(
    ...
    "final_results/three_sector_pathways"
)

PCT_FILE = ROOT / "three_sector_pathway_percentages_STRICT_CONUS.csv"

OUT_PNG = Path("/mnt/disk3/aoolaseinde/projects/ai-basin-hydrology/final_results/water_supply_pathways/three_sector_water_supply_pathways_FINAL.png")
OUT_PDF = Path("/mnt/disk3/aoolaseinde/projects/ai-basin-hydrology/final_results/water_supply_pathways/three_sector_water_supply_pathways_FINAL.pdf")
