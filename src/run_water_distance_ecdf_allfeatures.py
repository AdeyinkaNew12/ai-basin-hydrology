...
file = "/mnt/disk3/aoolaseinde/projects/integrated_dc_water_pathways/results/ecdf_sector_basin_matched/TABLE_ECDF_descriptives_dist_lake_km.csv"

df = pd.read_csv(file)

print(df[df["Sector"]=="AI"].to_string(index=False))
PY
